...
export const MOCK_STOCKS = [
  // ── DAX 40 ──────────────────────────────────────────────────────────────
  { symbol: 'SAP',   yahooSymbol: 'SAP.DE',   name: 'SAP SE',                     sector: 'Technologie',       price: 141.24, change:  1.74, changePct:  1.25, marketCap: 172000000000, pe: 38.2, history: generatePriceHistory(141,  365, 0.014) },
  { symbol: 'SIE',   yahooSymbol: 'SIE.DE',   name: 'Siemens AG',                 sector: 'Industrie',         price: 233.25, change:  6.50, changePct:  2.87, marketCap: 185000000000, pe: 17.4, history: generatePriceHistory(233,  365, 0.013) },
  { symbol: 'ALV',   yahooSymbol: 'ALV.DE',   name: 'Allianz SE',                 sector: 'Versicherung',      price: 380.10, change:  1.80, changePct:  0.48, marketCap: 148000000000, pe: 11.2, history: generatePriceHistory(380,  365, 0.011) },
  { symbol: 'DTE',   yahooSymbol: 'DTE.DE',   name: 'Deutsche Telekom AG',        sector: 'Telekommunikation', price:  31.15, change: -0.12, changePct: -0.38, marketCap: 148000000000, pe: 14.8, history: generatePriceHistory(31,   365, 0.012) },
  { symbol: 'MUV2',  yahooSymbol: 'MUV2.DE',  name: 'Münchener Rückversicherung', sector: 'Versicherung',      price: 556.80, change:  1.80, changePct:  0.32, marketCap:  70000000000, pe: 12.6, history: generatePriceHistory(557,  365, 0.011) },
  { symbol: 'IFX',   yahooSymbol: 'IFX.DE',   name: 'Infineon Technologies AG',   sector: 'Technologie',       price:  43.31, change:  0.92, changePct:  2.17, marketCap:  56000000000, pe: 24.1, history: generatePriceHistory(43,   365, 0.025) },
  { symbol: 'BMW',   yahooSymbol: 'BMW.DE',   name: 'BMW AG',                     sector: 'Automobil',         price:  83.54, change:  1.16, changePct:  1.41, marketCap:  50000000000, pe:  4.8, history: generatePriceHistory(84,   365, 0.017) },
  { symbol: 'MBG',   yahooSymbol: 'MBG.DE',   name: 'Mercedes-Benz Group AG',     sector: 'Automobil',         price:  53.96, change:  0.71, changePct:  1.33, marketCap:  56000000000, pe:  5.2, history: generatePriceHistory(54,   365, 0.016) },
  { symbol: 'BAS',   yahooSymbol: 'BAS.DE',   name: 'BASF SE',                    sector: 'Chemie',            price:  54.97, change:  1.39, changePct:  2.59, marketCap:  48000000000, pe: 22.4, history: generatePriceHistory(55,   365, 0.016) },
  { symbol: 'BAYN',  yahooSymbol: 'BAYN.DE',  name: 'Bayer AG',                   sector: 'Gesundheit',        price:  40.59, change:  0.14, changePct:  0.35, marketCap:  40000000000, pe: null, history: generatePriceHistory(41,   365, 0.022) },
  { symbol: 'VOW3',  yahooSymbol: 'VOW3.DE',  name: 'Volkswagen AG (Vz.)',        sector: 'Automobil',         price:  89.72, change:  0.54, changePct:  0.61, marketCap:  42000000000, pe:  3.6, history: generatePriceHistory(90,   365, 0.018) },
  { symbol: 'AIR',   yahooSymbol: 'AIR.PA',   name: 'Airbus SE',                  sector: 'Luftfahrt',         price: 171.68, change:  0.88, changePct:  0.52, marketCap: 134000000000, pe: 30.8, history: generatePriceHistory(172,  365, 0.016) },
  { symbol: 'LIN',   yahooSymbol: 'LIN.DE',   name: 'Linde plc',                  sector: 'Chemie',            price: 430.60, change: -1.40, changePct: -0.32, marketCap: 201000000000, pe: 29.6, history: generatePriceHistory(431,  365, 0.012) },
  { symbol: 'ADS',   yahooSymbol: 'ADS.DE',   name: 'adidas AG',                  sector: 'Konsumgüter',       price: 139.75, change:  2.75, changePct:  2.01, marketCap:  59000000000, pe: 44.2, history: generatePriceHistory(140,  365, 0.022) },
  { symbol: 'RWE',   yahooSymbol: 'RWE.DE',   name: 'RWE AG',                     sector: 'Energie',           price:  58.68, change: -0.24, changePct: -0.41, marketCap:  33000000000, pe:  8.4, history: generatePriceHistory(59,   365, 0.017) },
  { symbol: 'EOAN',  yahooSymbol: 'EOAN.DE',  name: 'E.ON SE',                    sector: 'Energie',           price:  19.66, change: -0.16, changePct: -0.83, marketCap:  44000000000, pe: 13.6, history: generatePriceHistory(20,   365, 0.013) },
  { symbol: 'DHL',   yahooSymbol: 'DHL.DE',   name: 'DHL Group',                  sector: 'Logistik',          price:  49.45, change:  0.82, changePct:  1.69, marketCap:  60000000000, pe: 12.4, history: generatePriceHistory(49,   365, 0.014) },
  { symbol: 'HNR1',  yahooSymbol: 'HNR1.DE',  name: 'Hannover Rück SE',           sector: 'Versicherung',      price: 252.80, change:  1.60, changePct:  0.64, marketCap:  30000000000, pe: 13.8, history: generatePriceHistory(253,  365, 0.011) },
  { symbol: 'MRK',   yahooSymbol: 'MRK.DE',   name: 'Merck KGaA',                 sector: 'Gesundheit',        price: 113.15, change:  1.75, changePct:  1.57, marketCap:  49000000000, pe: 21.4, history: generatePriceHistory(113,  365, 0.016) },
  { symbol: 'BEI',   yahooSymbol: 'BEI.DE',   name: 'Beiersdorf AG',              sector: 'Konsumgüter',       price: 143.85, change:  0.85, changePct:  0.59, marketCap:  35000000000, pe: 28.6, history: generatePriceHistory(144,  365, 0.012) },
  { symbol: 'HENKA', yahooSymbol: 'HENKA.DE', name: 'Henkel AG & Co. KGaA',       sector: 'Konsumgüter',       price:  86.40, change: -0.52, changePct: -0.60, marketCap:  35000000000, pe: 16.8, history: generatePriceHistory(86,   365, 0.012) },
  { symbol: 'VNA',   yahooSymbol: 'VNA.DE',   name: 'Vonovia SE',                 sector: 'Immobilien',        price:  29.86, change:  0.48, changePct:  1.63, marketCap:  22000000000, pe: null, history: generatePriceHistory(30,   365, 0.018) },
  { symbol: 'CON',   yahooSymbol: 'CON.DE',   name: 'Continental AG',             sector: 'Automobil',         price:  63.28, change:  1.22, changePct:  1.97, marketCap:  12000000000, pe:  8.2, history: generatePriceHistory(63,   365, 0.018) },
  { symbol: 'FRE',   yahooSymbol: 'FRE.DE',   name: 'Fresenius SE & Co. KGaA',    sector: 'Gesundheit',        price:  35.40, change:  0.64, changePct:  1.84, marketCap:  19000000000, pe: 16.2, history: generatePriceHistory(35,   365, 0.015) },
  { symbol: 'MTX',   yahooSymbol: 'MTX.DE',   name: 'MTU Aero Engines AG',        sector: 'Luftfahrt',         price: 278.50, change:  4.20, changePct:  1.53, marketCap:  14000000000, pe: 22.8, history: generatePriceHistory(279,  365, 0.016) },
  // ── MDAX / TecDAX Auswahl ────────────────────────────────────────────────
  { symbol: 'DBK',   yahooSymbol: 'DBK.DE',   name: 'Deutsche Bank AG',           sector: 'Finanzen',          price:  27.98, change:  0.37, changePct:  1.34, marketCap:  55000000000, pe:  6.8, history: generatePriceHistory(28,   365, 0.021) },
  { symbol: 'CBK',   yahooSymbol: 'CBK.DE',   name: 'Commerzbank AG',             sector: 'Finanzen',          price:  34.36, change:  0.25, changePct:  0.73, marketCap:  43000000000, pe:  7.4, history: generatePriceHistory(34,   365, 0.022) },
